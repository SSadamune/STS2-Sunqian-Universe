...
{
	public const int CanonicalDamage = 17;
	public const int UpgradedDamage = 19;
	public const int CanonicalDexterityMultiplier = 3;
	public const int UpgradedDexterityMultiplier = 4;
