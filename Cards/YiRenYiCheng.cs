...
[RegisterCard(typeof(SunqianCardPool), StableEntryStem = "yi_ren_yi_cheng")]
public sealed class YiRenYiCheng : ScriptCardTemplate
{
	...
	public override CardAssetProfile AssetProfile => new(
		PortraitPath: "res://images/cards/YiRenYiCheng.png");
	...
	protected override async Task PlayScriptAsync(PlayerChoiceContext choiceContext, CardPlay cardPlay)
	{
		...
		await PowerCmd.Apply<ScriptYiRenYiChengPower>(
			choiceContext,
			Owner.Creature,
			1m,
			Owner.Creature,
